...
import tech.reliab.course.panarinke.bank.enums.CrudOperationException;
import tech.reliab.course.panarinke.bank.enums.CrudOperations;
import tech.reliab.course.panarinke.bank.enums.WorkStatus;
import tech.reliab.course.panarinke.bank.exceptions.BankTransactionException;
...
public class Lab3 {
    ...
    private void requestLoan() {
        ...
        User user = userService.create(
                new FCs("Panarin", "Kirill", "Evgenievich"),
                "Programmer",
                userBank
        );
